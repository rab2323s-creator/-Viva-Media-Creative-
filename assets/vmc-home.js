...
const dict = {
  ar: {
    ...
    hero_sub: "ندمج التصميم الراقي مع السرد السينمائي واستراتيجية الأداء—لنجعل علامتك تبدو “باهظة الثمن” وتحقق نتائج ملموسة.",
    ...
    services_desc: "باقات تنفيذ “بوتيك” بجودة عالمية—بدون حشو. كل قسم مصمم ليبدو مثل صفحة وكالة دولية.",
    ...
    t1: "وضوح الرسالة", t1d: "نكتب ما يُفهم بسرعة—ثم نصممه بطريقة تُحس.",
    t2: "جودة التنفيذ", t2d: "تفاصيل صغيرة تصنع فرقًا كبيرًا: حركة، مسافات، إيقاع.",
    t3: "اتساق الهوية", t3d: "نظام تصميم يحمي صورتك عبر كل منصة.",
    t4: "إبداع يقاس", t4d: "نحب الجمال… لكن نحب النتائج أكثر.",
    t5: "سرعة بدون فوضى", t5d: "نُنجز بسرعة مع نظام واضح ومسار تسليم نظيف.",
    t6: "طابع عالمي", t6d: "لغة بصرية تناسب برلين… كما تناسب دبي.",
  ...
  en: {
    ...
    hero_sub: "We blend luxury design, cinematic storytelling, and performance strategy—built to look expensive and convert.",
    ...
    services_desc: "Boutique execution with global polish—no fluff. Each section is built to feel like a top-tier agency.",
    ...
    t1: "Clarity", t1d: "Say it fast. Make it felt.",
    t2: "Craft", t2d: "Micro-details: motion, spacing, rhythm.",
    t3: "Consistency", t3d: "A system that protects your brand everywhere.",
    t4: "Measurable creativity", t4d: "Beauty—then results.",
    t5: "Fast, not messy", t5d: "Speed with a clean delivery process.",
    t6: "Global taste", t6d: "A visual language that works worldwide.",
    ...
    final_desc: "Share your goal and project type—we’ll propose a luxury direction with a conversion-first structure.",
