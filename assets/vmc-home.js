...
const dict = {
  ar: {
   ...
   hero_kicker: "تأثير يُدار باحتراف • شراكات تُبنى بذكاء • نتائج تُقاس بالأرقام",
    ...
    services_seo_title:
  "خدمات إدارة المشاهير والتسويق عبر المؤثرين لزيادة المبيعات وبناء العلامات التجارية",

services_seo_desc:
  "تقدم Viva Media Creative حلولًا استراتيجية لإدارة المشاهير وصُنّاع المحتوى، وبناء شراكات مؤثرة مع العلامات التجارية، وصناعة ترندات قابلة للتحويل إلى طلبات ومبيعات فعلية. نعمل مع علامات وشخصيات تسعى إلى نمو مستدام في الخليج ومصر والعالم العربي، حيث يتم ربط التأثير الرقمي بأهداف تجارية قابلة للقياس بدل الاكتفاء بالانتشار.",

services_seo_li1:
  "إدارة وربط المشاهير بالعلامات التجارية — لتحويل التأثير إلى شراكات مدفوعة ونتائج تجارية.",

services_seo_li2:
  "إدارة حسابات المشاهير وصُنّاع المحتوى — لبناء حضور رقمي ثابت يعزّز الثقة ويجذب الطلب.",

services_seo_li3:
  "صناعة المحتوى والترندات على السوشيال ميديا — لرفع الوصول وتحفيز الاهتمام الحقيقي بالعلامة.",

services_seo_li4:
  "كتابة السكريبتات والنصوص الإعلانية (Copywriting) — لتحسين التحويل وربط المشاهدات بالمبيعات.",

services_seo_li5:
  "التسويق للمواقع والمتاجر الإلكترونية (SEO & Growth) — لزيادة الطلب العضوي وتحقيق نمو قابل للقياس.",
